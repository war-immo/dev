...
public class CrashMixer implements HitInterface {
	...
	public CrashMixer(HitInterface ord, HitInterface  top,HitInterface  rim, HitInterface bel) {
		this.bel = bel;
		this.top = top;
		this.ord = ord;
		this.rim = rim;
	...
	public void hit(long frame) {
		...
		ord.hit(frame,dB+functionTables.GaintodB(rimXbel*rimXord*(1.f-ordXtop)));
		top.hit(frame,dB+functionTables.GaintodB(rimXbel*rimXord*ordXtop));
