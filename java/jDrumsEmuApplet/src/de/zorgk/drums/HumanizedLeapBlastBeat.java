...
public class HumanizedLeapBlastBeat implements RiffInterface, Cloneable {
	...
	public HumanizedLeapBlastBeat(long bpm, long hits, float accuracyInMs,
			float openClosed, float openClosed2Sigma, float ordTop,
			float ordTop2Sigma, SamplerSetup sampler) {
		...
		this.uniformAccuracy = (int) (accuracyInMs
				* RiffInterface.framesPerSecond / 1000.f);
