...
public interface RiffInterface {
	 ...
	 * 
	 * @param framestart       start of interval
	 * @param framenextstart   start of next interval (one frame after interval ends)
	 * @param stack            for modification of the RiffInterface-stack by the object
	 * @param sampler          sampler object (use for hitting drums etc.)
	 * @return true to be removed from stack (after reaching the end of the riff)
	 */
