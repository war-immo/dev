...
public class HumanizedStraightBlastBeat implements RiffInterface, Cloneable {
	...
	public HumanizedStraightBlastBeat(long bpm, long hits, float accuracyInMs, float openClosed, float openClosed2Sigma, float ordTop, float ordTop2Sigma, SamplerSetup sampler) {
